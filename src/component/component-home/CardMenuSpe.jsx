...
const CardMenuSpe = ({images, name, price, desc}) => {
  return (
    <div className="max-w-[264px]">
      <div className="">
        <img src={images} alt="salad" />
      </div>
      <div className="bg-[#495E57] text-[#F4CE14] p-3">
        <div className="flex justify-between">
          <p className="text-[20px] font-semibold w-[140px]">{name}</p>
          <p className="mt-1 text-[#EE9972] font-semibold">{price}</p>
        </div>
